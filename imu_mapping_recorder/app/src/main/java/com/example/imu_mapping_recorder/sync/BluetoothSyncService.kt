...
import com.example.imu_mapping_recorder.MainActivity
import com.example.imu_mapping_recorder.R
import com.example.imu_mapping_recorder.SensorRecorderService
...
class BluetoothSyncService : Service() {
    ...
    companion object {
        ...
        const val ACTION_CONNECT = "com.example.imu_mapping_recorder.CONNECT"
        const val ACTION_LISTEN = "com.example.imu_mapping_recorder.LISTEN"
        const val ACTION_DISCONNECT = "com.example.imu_mapping_recorder.DISCONNECT"
        const val ACTION_SYNC_CLOCKS = "com.example.imu_mapping_recorder.SYNC_CLOCKS"
