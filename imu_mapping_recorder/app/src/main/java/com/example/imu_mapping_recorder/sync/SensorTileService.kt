...
class SensorTileService : Service() {
    ...
    companion object {
        const val ACTION_SCAN       = "com.example.imu_mapping_recorder.ACTION_ST_SCAN"
        const val ACTION_DISCONNECT = "com.example.imu_mapping_recorder.ACTION_ST_DISCONNECT"
    ...
    private fun startScan() {
        ...
        try {
            ...
            Timber.e(e, "Failed to start foreground service - missing permissions")
            connectionState = SensorTileConnectionState.ERROR
            errorMessage = "Missing BT permissions for background service"
            updateNotification()
            return
        }
